...
public class ProductsListAdapter extends RecyclerView.Adapter<ProductsListAdapter.ViewHolder> {
    ...
    @Override
    /**
     * This is overriden method, attach the list item layout to View
     * @retun viewHolder .
     */
    ...
    @Override
    /**
     * This  is overriden method, assign dynamic values to respective view elements
     */
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        // define all view items from layout file which values assign dynamically in runtime
        ViewHolder(View v) {
            super(v);
